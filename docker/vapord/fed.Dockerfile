...
COPY ./docker/vapord/fed_config.toml /usr/local/vapord/config.toml
COPY ./docker/vapord/federation.json /usr/local/vapord/federation.json
COPY ./docker/vapord/fed_key.txt /usr/local/vapord/node_key.txt
COPY ./docker/vapord/fed_pkey.txt /usr/local/vapord/node_pubkey.txt
RUN touch /usr/local/vapord/is_fed
